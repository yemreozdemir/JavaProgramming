...
public class CydeoStudents_Task {
    ...
    public static void main(String[] args) {
        ...
        String[][] batch25Group= {batch25Group1, batch25Group2, batch25Group3};
        ...
        String[][] batch24Group = {batch24Group1, batch24Group2, batch24Group3};

        String[][][] cydeoStudents = {batch24Group,batch25Group};
...
3. CydeoStudents Task:
		...
		5. declare an array variable named CydeoStudents and assign batch24Groups & batch25Groups to the indexes of
		 CydeoStudents
